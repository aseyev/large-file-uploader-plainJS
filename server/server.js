...
app.post('/upload', (req, res) => {
  ...
  if (!startByte) {
    console.log("upload createWriteStream file:", upload);
    ...
    // console.log("upload createWriteStream W file:", fileStream);
  } else {
    ...
    console.log("upload createWriteStream A filePath:", filePath);
